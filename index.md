...
collects, uses, and shares user data, and every party data is shared with.

## What RefLinx collects and how it is used

RefLinx stores the following in your browser's local storage (IndexedDB and
...
uninstalling the extension removes all of its browser storage. If you enable
auto-backup or export your library, RefLinx writes files to a location on your
own disk that you choose, with your browser's permission; those copies are
yours to manage.
